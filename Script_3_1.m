...
rastr = 1;  % O sistema possui sistema de rastreamento em dois eixos
    ...
    crit_max = 75;  % Valor máximo para o critério utilizado
    crit_min = 1;   % Valor mínimo para o critério utilizado
    crit_inc = 2;   % Valor do incremento para o critério utilizado
    d_omega = 0.25;    % Incremento nos valores do ângulo da hora solar, [o].
...
cidades = {'Manaus - AM 3ºS','Garanhuns - PE 8ºS','Brasilia - DF 15ºS','Belo Horizonte - MG 19ºS','Campo Grande - MS 20ºS','Joacaba - SC 27ºS','Sao Gabriel - RS 30°S'};
