...
rad = 3; % Definicao da fonte dos dados de radiação solar:
         %              1 = Radiação solar horária
         %              2 = Radiação solar diária
         %              3 = Radiação solar estimada para dia claro
...
elseif rad == 3
    ...
    clima = 1;% Definicao do clima da região estudada:
              %              1 - Clima tropical
